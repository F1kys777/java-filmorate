...
public class UserDbStorage extends BaseRepository<User> implements UserStorage {
    ...
    private static final String FRIEND_ADD_QUERY = "INSERT INTO friendship (user_id, friend_id, status) VALUES (?, ?, 'PENDING')";
    ...
    public void addFriend(long userId, long friendId) {
        insert(FRIEND_ADD_QUERY, userId, friendId); // или update, но insert с возвратом id не нужен
    }
